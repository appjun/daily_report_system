...
public class EmployeeService extends ServiceBase{
    ...
    public long countByCode(String code) {
        ...
        long employees_count = (long) em.createNamedQuery(JpaConst.Q_EMP_COUNT_REGISTERED_BY_CODE,Long.class).setParameter(JpaConst.JPQL_PARM_CODE,code).getSingleResult();
